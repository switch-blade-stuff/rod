...
namespace rod
{
	namespace _start_detached
	{
		...
		public:
			explicit detached_state(Snd &&snd) noexcept(detail::nothrow_callable<connect_t, Snd, receiver_t>) : base_t(connect(std::forward<Snd>(snd), receiver_t{this})) { start(static_cast<base_t &>(*this)); }
		...
		public:
			template<rod::sender Snd> requires detail::tag_invocable_with_completion_scheduler<detach_local_t, set_value_t, Snd, Snd>
			...
			template<rod::sender Snd> requires(!detail::tag_invocable_with_completion_scheduler<detach_local_t, set_value_t, Snd, Snd> && tag_invocable<detach_local_t, Snd>)
			...
			template<rod::sender Snd> requires(!detail::tag_invocable_with_completion_scheduler<detach_local_t, set_value_t, Snd> && !tag_invocable<detach_local_t, Snd>)
