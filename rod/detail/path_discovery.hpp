...
namespace rod
{
	...
	namespace _detail
	{
		...
		result<path> find_cache_home_dir() noexcept;
		result<path> find_state_home_dir() noexcept;
		result<path> find_data_home_dir() noexcept;
		result<path> find_config_home_dir() noexcept;
